/*
  Copyright (c) SilverSat Limited (https://silversat.org)
  ...
  This file has been modified from the Arduino MKR WiFi 1010 board definition, 
  copyrighted 2014-15 Arduino LLC under the LGPL. It was originally modified
  by (GitHub) tconrad26 to enable an extra WiFi dongle.
*/
...
//  { PORTB, 23, PIO_SERCOM_ALT, (PIN_ATTR_DIGITAL                             ), No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, // RX:   SERCOM5/PAD[3]
  ...
  { PORTA, 20, PIO_SERCOM_ALT, (PIN_ATTR_DIGITAL), No_ADC_Channel, NOT_ON_PWM,   NOT_ON_TIMER,     EXTERNAL_INT_NONE    }, //D6 is Tx for Serial 3
//  { PORTA, 21, PIO_DIGITAL, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER_ALT), No_ADC_Channel, PWM0_CH7,   TCC0_CH7,     EXTERNAL_INT_5    },
  { PORTA, 21, PIO_SERCOM_ALT, (PIN_ATTR_DIGITAL), No_ADC_Channel, NOT_ON_PWM,   NOT_ON_TIMER,     EXTERNAL_INT_5    }, //D7 is Rx for Serial 3, so it should have the external interrupt
